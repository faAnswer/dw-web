...
export default function SaveProfileDialog (props) {
  const { title, setFormDialog, isFormDialogOpened, handleSubmitButtonClicked, saveProfileName, setSaveProfileName, saveLayoutOptionList, saveMode, setSaveMode } = props
    ...
    >
      ...
      <div className='submit-button-wrapper'>
        <div className='button-wrapper'>
          <Button onClick={() => handleSubmitButtonClicked(saveMode)}>Save</Button>
        </div>
      </div>
    </CustomDialog>
  )
